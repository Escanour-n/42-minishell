...
#    Updated: 2023/05/14 15:39:27 by nouakhro         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
UTILS = $(addprefix utils/,  untils_unset utils_rediraction utils_pwd_commande utils utils_cd_command utils_check_rediractions_chiled utils_check_rediractions_parent utils_check_rediractions_parent_2 utils_exit_commande utils_export_command_1 utils_export_command_2 utils_export_command_3)
